      ...
      <div className="flex h-full justify-center">
        ...
        >
          <div className="h-[66px] relative flex items-center justify-between w-full">
            <h1 className="text-gray-200 text-3xl font-mono hidden md:flex">
              Sorting Visulizer
            </h1>
            ...
            <div className="hidden sm:flex absolute top-[120%] left-0 w-full">
              <div className="flex w-full text-gray-300 p-4 rounded-lg border border-system-purple60 bg-system-purple50 bg-opacity-10 gap-6 ">
                <div className="flex flex-col items-start justify-start w-3/4">
                  <h3 className="text-lg font-mono">
                    {sortingAlgorithmsData[selectedAlgorithm].title}
                  </h3>
                  <p className="text-sm text-gray-400  text-grey-500 pt-2">
                ...
                <div className="flex flex-col items-start justify-start w-1/4 gap-2">
                  ...
                  <div className="flex flex-col gap-2">
                    <p className="flex w-full text-sm text-gray-400">
